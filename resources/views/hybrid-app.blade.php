@include('app')
    <style>
        .bg-image-app {
            background-image: url("https://www.techasoft.com/debug/img/hybrid_app_img.jpg");
        }
    </style>
    <main>
    ...
    <h2 class="my-auto text-light ml-md-4 ml-2 w-50">HYBRID APP DEVELOPMENT</h2>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">Hybrid App Development</h2>
    </div>
    </div>
    ...
    <div class="row technology_contents-ui">
    <div class="col-sm-12">
    <h4 class="font-weight-bold text-let pb-2 text-center px-5">Hybrid is a cross-platform mobile development app. Benefits of the hybrid app are –</h4>
     <h5 class=" px-5 pb-1 font-weight-bold optimize"> Improved user experience</h5>
    ...
    <div class="col-md-12">
    <h5 class=" px-5 pb-1 font-weight-bold optimize">Accessibility</h5>
    <p class="text-justify para-color px-5 pb-1">
    ...
    <div class="col-md-12">
    <h5 class=" px-5 pb-1 font-weight-bold optimize">Speed</h5>
    <p class="text-justify para-color px-5 pb-1">
    ...
    <div class="col-md-12">
    <h5 class=" px-5 pb-1 font-weight-bold optimize">Integration</h5>
    <p class="text-justify para-color px-5 pb-1">
    Hybrid apps have an advantage of easily integrating various features in it. </p>
    </div>
    <div class="col-md-12">
    <p class="text-justify para-color para-color px-5 pb-1">A single approach is not suitable for all businesses that are why we focus on customized solutions. The apps delivered by us are highly polished, finest and superlative features, easy to download and install, improved performance, with an interactive interface, filled with features and cost-effective.</p>
    </div>
    </div>
    </div>
    <div class="product-description--div p-4">
    ...
    <p class="text-justify px-5 pb-1">
    <strong>TECHASOFT is a renowned HYBRID APP DEVELOPMENT COMPANY IN BANGALORE. Our hybrid app development
    services are highly trusted by our customers because of–</strong></p>
    </div>
    <div class="col-md-12 px-5 pb-1">
    <ul class="para-color xam-list" style="list-style-type: none;">
    <li class="ml-1">
    ...
    <input hidden="" type="text" value="/Hybrid-App-Development-company" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/Hybrid-App-Development-company" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=k2cos9184odt" width="304" height="78" role="presentation" name="a-5iijdj9bj4tg" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
