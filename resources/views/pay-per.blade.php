@include('app')
    ...
    <div class="col-12">
    <div class="row">
    <div class="backgrund-image-txt-left">
    <div class="row h-100">
    <div class="col-lg-6 col-9 d-flex">
    <h1 class="text-center m-auto text-light">PPC MANAGEMENT SERVICES</h1>
    </div>
    </div>
    </div>
    </div>
    ...
    TECHASOFT delivers the best PPC MANAGEMENT SERVICES with being the main ruling firm in the IT sector. We are often considered as the trump card for the PPC services as we offer a huge number of leads for your business like –
    </p>
    </div>
    ...
    We create services that directly take you to the users searching for the similar services supplied by you.
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    You don’t have to struggle for the outcomes. As we establish ourselves as the leading PPC MANAGEMENT COMPANY IN BANGLORE, our results are also well established to progress your business.
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    Our PPC services can target a wider range of audience from a specific geographical location and can even run language specific campaigns.
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    The returns are guaranteed on your investments.
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    It can convert visitors into potential customers.
    </li>
    </ul>
    </div>
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1">
    Our pay per-per-click services enhance your search engine results using targeted keywords. We deliver relevant traffic to your site to head your brand in the world of digital marketing. As TECHASOFT is also one of the top-ranked GOOGLE ADS MANAGEMENT COMPANY IN BANGALORE, our marketing insights are so strong that we drive most of the online marketing services. TECHASOFT is the one-stop solution for the PPC optimization and management services with great pricing and delivery strategies.
    </p>
    <p class="text-justify px-5 pb-1">
    ...
    <li>
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon" alt="tick" width="20" height="20"> Timely delivery of projects
    Great keywords selection
    </li>
    <li>
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon" alt="tick" width="20" height="20"> Timely delivery of projects
    ...
    <li>
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon" alt="tick" width="20" height="20"> Timely delivery of projects
    Call tracking and phone support
    </li>
    <li>
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon" alt="tick" width="20" height="20"> Timely delivery of projects
    PPC bid management
    ...
    <li>
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon" alt="tick" width="20" height="20"> Timely delivery of projects
    Refining keywords lists
    </li>
    <li>
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon" alt="tick" width="20" height="20"> Timely delivery of projects
    Maintenance of PPC campaign
    </li>
    </ul>
    </div>
    </div>
    ...
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1 ">
    Don’t forget to consult TECHASOFT while planning your overall internet marketing strategy and head up with our quality PPC MANAGEMENT SERVICES.
    </p>
    </div>
    ...
    <input hidden="" type="text" value="/ppc-management-company-bangalore" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/ppc-management-company-bangalore" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=tplmbiqhz79k" width="304" height="78" role="presentation" name="a-84nolvcvk5f9" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
