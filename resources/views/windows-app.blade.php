@include('app')
    <style>
        .bg-image-app {
            background-image: url("https://www.techasoft.com/debug/img/windows_app_dev_img.jpg");
          }
    </style>
    <main>
    ...
    <h2 class="my-auto text-light ml-4 w-50">WINDOWS APP DEVELOPMENT</h2>
    </div>
    </div>
    </div>
    </div>
    ...
    <ul style="list-style-type: none;" class="xam-list">
    <li class="ml-1">
    ...
    <div class="product-description--div p-4">
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center services_head">Why choose us?</h2>
    </div>
    <div class="row project-mean">
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1 ">
    ...
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1 ">The software used for developing these apps are latest and have an inbuilt mechanism for error detection in case of improper functioning of the app.</p>
    </div>
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1 ">Only a Wide range of companies offer iOS and android app development services, but TECHASOFT is one of the rare WINDOWS APP DEVELOPMENT COMPANY developing solutions for your every need and requirement. </p>
    </div>
    ...
    <input hidden="" type="text" value="/Windows-App-Development-company" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/Windows-App-Development-company" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=6c7la5li8p1u" width="304" height="78" role="presentation" name="a-qudpyj3xrmhd" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
