@include('app')
    <style>
        .bg-image-app {
            background-image: url("https://www.techasoft.com/debug/img/native_app_img.jpg");
        }
    </style>
    <main>
    ...
    <h2 class="my-auto text-light ml-4 w-50">NATIVE APP DEVELOPMENT</h2>
    </div>
    </div>
    </div>
    </div>
    ...
    <p class="text-justify px-5 pb-1 ">
    <strong>TECHASOFT</strong> is the premium NATIVE APP DEVELOPMENT COMPANY IN BANGALORE. After serving diverse sectors like healthcare, e-commerce, banking and finance, education, media and entertainment, travel and hospitality and many more, we have reached a level of excellence in delivering growth-oriented projects. If you are interested in knowing more about TECHASOFT and our development process or the way we drive businesses, then contact us to put your best foot forward for the growth of your business.
    </p>
    </div>
    ...
    <input hidden="" type="text" value="/Native-App-Development-Company" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/Native-App-Development-Company" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=n6cvnpiojlcd" width="304" height="78" role="presentation" name="a-2vywqhh5sx79" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
