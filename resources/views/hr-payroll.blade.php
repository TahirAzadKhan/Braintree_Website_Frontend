@include('app')
    ...
    <h1 class="text-uppercase font-weight-bold services_head">HR and Payroll Management Software</h1>
    </div>
    <div class="col-md-6 img-div">
    <img src="https://www.techasoft.com/debug/img/hr_payroll.png" class="img-fluid" alt="About image">
    </div>
    </div>
    </div>
    </div>
    ...
    Human resources management is an online repository for keeping employees reviews and up-to-date data of employees for easy reference. TECHASOFT, <strong>HR and PAYROLL management software Development Company in Bangalore</strong> is the main firm for developing this software. Our software is built with technical intelligence and is meant to improve your business performance and efficiency. The management system can be easily integrated with any accounting system and connects various modules like time and attendance, government forms, timesheet module and accounting integration module. The software is configurable and scalable to fulfil every needs and requirement of your organization. Our payroll management services are comprehensive for timely distribution of salaries and to secure access to all the details.
    </p>
    <p class="text-justify px-5 pb-1 ">
    Our intuitive tools are meant to get you started. Various key benefits of our HR and PAYROLL management software are –
    </p>
    </div>
    ...
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    v Control costs of data entry into various systems
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    ...
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    Highly integrated with your existing system and Efficient in managing employee’s information
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    ...
    <input hidden="" type="text" value="/hr-payroll-management-software-company" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/hr-payroll-management-software-company" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=1dztallwnynx" width="304" height="78" role="presentation" name="a-t7lgb8c8myj5" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
