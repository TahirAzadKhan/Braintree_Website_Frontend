@include('app')
    ...
    <h1 class="font-weight-bold vertical-alignment">Employee Leave Management </h1>
    </div>
    <div class="col-sm-7 main-image text-center">
    <img src="https://www.techasoft.com/uploads/logo_(2).png" alt="product page image" width="60%" height="60%" class="product-drlog">
    </div>
    </div>
    ...
    <a href="https://elm.techasoft.com/" target="_blank" class="social-btns">
    ...
    <a href="https://play.google.com/store/apps/details?id=com.techasoft.elm" target="_blank" class="social-btns my-md-auto my-3">
    ...
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">About Employee Leave Management </h2>
    </div>
    </div>
    ...
    <input hidden="" type="text" value="/employee-leave-management-" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/employee-leave-management-" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=hajwb8g1crxc" width="304" height="78" role="presentation" name="a-b28lxexibid9" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
