@include('app')
    ...
    <h1 class="text-uppercase font-weight-bold services_head">Inventory Management System</h1>
    </div>
    <div class="col-md-6 img-div">
    <img src="https://www.techasoft.com/debug/img/inventory_management.png" class="img-fluid" alt="About image">
    </div>
    </div>
    </div>
    </div>
    ...
    In today’s time, we are more addicted to ordering from home than to go and shop. We want everything to be done while we are sitting relaxed in our homes. Then, here the Techasoft acts as your savior. Yes, you heard it right.
    </p>
    <p class="text-justify px-5 pb-1 ">
    The <a href="https://www.techasoft.com/" class="techasoft__link--style">Techasoft</a> work hard every day to meet our client’s every basic requirement and then we come up with the best <strong>inventory Management System software development company in Bangalore</strong>. We are offering the best inventory management system services to our customers for the easy tracking of deliveries, sales, orders, and many other things.
    We assure our client the best work at the lowest possible prices. The inventory management system has the wide range of benefits which will definitely force you to work within us. Some of the benefits can be the –
    </p>
    </div>
    ...
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1 ">
    Techasoft promises the best software to the clients and thus our organization enables our clients to track and manage the flow of parts and equipment. There are many more benefits that we provide you and it can be the
    </p>
    </div>
    <div class="col-sm-12 px-5 pb-1">
    ...
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    <strong>Free from the bugging problems –</strong> we assure our clients the error-free work at the lowest possible prices.
     </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    <strong>Easier to install the system –</strong> the easy to install of the system that will definitely attract more audience
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    <strong>Safe and secure data –</strong> our hardworking staff assure our clients with the complete security of their data
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    <strong>Require fewer efforts –</strong> you can easily sit and relax your home while working upon our system.
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    <strong>Quality work –</strong> our organization assure you the best quality work and trust us our low prices will never affect the quality of our work.
    Work with Techasoft for the best future experience.
    </li>
    </ul>
    </div>
    </div>
    ...
    <div class="product-description--div p-4">
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">Why choose us?</h2>
    </div>
    <div class="row project-mean">
    <div class="col-12">
    <div class="row two-lists">
    <div class="col-md-6 px-4 pb-1">
    ...
    <li>
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon" alt="tick" width="20" height="20">
    Highly trained and focused professional
    </li>
    </ul>
    </div>
    <div class="col-md-6 px-4 pb-1">
    ...
    <input hidden="" type="text" value="/inventory-software-development-company" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/inventory-software-development-company" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=c4jqq64t344s" width="304" height="78" role="presentation" name="a-70o1zzw0zxrw" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
