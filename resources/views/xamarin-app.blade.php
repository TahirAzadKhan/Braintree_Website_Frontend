@include('app')
    <style>
        .backgrund-image-txt-left {
            background-image: url("https://www.techasoft.com/debug/img/xamarin_img.jpg");
        }
    </style>
    <main>
    ...
    <h1 class="text-center m-auto text-light">XAMARIN APP DEVELOPMENT</h1>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">Xamarin App Development</h2>
    </div>
    </div>
    <div class="row project-mean">
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1 ">
    In this generation, Xamarin acts as the best platform to work on and thus a number of companies are developing their mobile apps using Xamarin. As it is the only platform which allows the user to develop the native apps in c# language, it serves as one of the widely used platforms. We are the top leading Xamarin app development company in Bangalore. Our organization knows the value of your money and thus assures our client best services at the lowest possible prices. There are the different reasons which will make you force to work with Xamarin.
    </p>
    <p class="text-justify px-5 pb-1 ">
    ...
    <input hidden="" type="text" value="/xamarin-app-development" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/xamarin-app-development" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=e1nh44j3dwh9" width="304" height="78" role="presentation" name="a-7yvyrpp502j8" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
