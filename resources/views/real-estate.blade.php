@include('app')
    <style>
        .bg-image-app {
            background-image: url("https://www.techasoft.com/debug/img/real_estate_web_img.jpg");
        }
    </style>
    <main>
    ...
    <h2 class="my-auto text-light ml-4 w-50">REAL ESTATE WEB PORTAL DEVELOPMENT</h2>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">Improving Businesses Since Years</h2>
    </div>
    </div>
    <div class="row project-mean">
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1 ">
    <a href="https://www.techasoft.com/" class="techasoft__link--style">Techasoft</a> is the pioneer <strong>real estate web portal development company in Bangalore</strong>. Our developmental solutions are customized for both small and large category businesses. With the advent of the real estate industry, it is now crucial for businesses to develop their web portals to gain significant importance. We design, develop and depart your responsive real estate websites to enhance your web personality. If you deal in the real estate industry then Techasoft is the perfect solution to differentiate you from your other competitors and build your brand name.
    </p>
    <p class="text-justify px-5 pb-1 ">
    ...
    <input hidden="" type="text" value="/real-estate-web-portal-development-company" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/real-estate-web-portal-development-company" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=6ez6vym9hnoz" width="304" height="78" role="presentation" name="a-pu3718ico86z" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
