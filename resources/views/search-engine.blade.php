@include('app')
    ...
    <h1 class="text-uppercase font-weight-bold services_head">Search Engine Marketing</h1>
    </div>
    <div class="col-md-6 img-div">
    <img src="https://www.techasoft.com/debug/img/search_marketing.png" class="img-fluid" alt="About image" style="width: 80%;">
    </div>
    </div>
    </div>
    </div>
    ...
    Search Engine Marketing (SEM) is also a technique to generate traffic on your website. Search Engine Marketing refers to harnessing the capabilities of the internet search engines to enhance the online
    presence of your website as a business in the market.
    It generates the maximum number of users to visit your site.
    A reliable marketing tool, SEM serves as a quick, simple and cost-effective
    solution to get a great flow of traffic on your website. It is the perfect strategy
    if the business is not getting enough traffic organically, with the help of SEO techniques alone.
    With SEM, the search engine optimization techniques are used in combination with the paid advertising
    strategies to get speedy and effective results for the websites.</p>
    <p class="text-justify px-5 pb-1 ">
    Techasoft is a well-known name as a<strong> Search Engine Marketing company in Bangalore</strong>. We are a <strong>Koramangala, Bangalore</strong> based company in India, but we are working across the nation.
    </p>
    <p class="text-justify px-5 pb-1 ">Techasoft, Bangalore is achieving the high position in top ranking in
    Search Engine Marketing companies. The websites to whom we are helping in SEM services are
    also resulting on the top. We are offering the best SEM services that too with most effective
    for better traffic and growth. Techasoft is the best choice for the lead generation and increasing
    ROI, to grow businesses to be the best and get ahead of the competition.</p>
    <p class="text-justify px-5 pb-1 "> SEM is a part of the digital market, and digital marketing is becoming an
    important part of website marketing or web advertising.</p>
    </div>
    </div>
    </div>
    <div class="product-description--div p-4">
    ...
    <div class="col-sm-12">
    <h4 class="font-weight-bold text-let pb-2 text-center">Techasoft Services, which we would love to provide you</h4>
    <h5 class=" px-5 pb-1 font-weight-bold optimize">Keyword Research</h5>
    ...
    <div class="col-md-12">
    <h5 class=" px-5 pb-1 font-weight-bold optimize">Market Analysis</h5>
    <p class="text-justify para-color  px-5 pb-1">
    ...
    <div class="col-md-12">
    <h5 class=" px-5 pb-1 font-weight-bold optimize">Ad Campaigning Design</h5>
    <p class="text-justify para-color px-5 pb-1">
    TA coordinated series of linked with a single idea. An advertising campaign is typically broadcast through different media channels. It may focus on a common theme and one or a few brands or products, or be directed at a particular segment of the population. Techasoft will design this ad campaign for you.
    </p>
    </div>
    <div class="col-md-12">
    <h5 class=" px-5 pb-1 font-weight-bold optimize">PPC Services</h5>
    <p class="text-justify para-color px-5 pb-1">
    ...
    <div class="row technology_contents-ui">
    <div class="col-sm-12">
    <h4 class="font-weight-bold text-let pb-2 text-center px-5">Benefits of Techasoft Search engine optimization Services</h4>
    </div>
    <div class="col-sm-12 px-5 pb-1 para-color">
    ...
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    Improve measurable results of your website. Will connect prosper clients with your website. </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    As Techasoft is the leading Search Engine Optimization Company in Bangalore, We assure you the loyalty, time management towards your work, lowest prices and high profile team for your projects.
    </li>
    </ul>
    </div>
    ...
    <input hidden="" type="text" value="/Search-Engine-Marketing-Company-Bangalore" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/Search-Engine-Marketing-Company-Bangalore" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=yl27pmkj42dl" width="304" height="78" role="presentation" name="a-ga3a0uizarra" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
