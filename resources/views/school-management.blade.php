@include('app')
    <style>
        .backgrund-image-txt-left {
            background-image: url("https://www.techasoft.com/debug/img/school_mangement.jpg");
        }
    </style>
    <main>
    ...
    <div class="row h-100">
    <div class="col-lg-6 col-3 d-flex">
    </div>
    <div class="col-lg-6 col-9 d-flex">
    <h1 class="text-center m-auto">SCHOOL MANAGEMENT <br>SYSTEM SOFTWARE</h1>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">School Management Software</h2>
    </div>
    </div>
    <div class="row project-mean">
    <div class="col-sm-12">
     <p class="text-justify px-5 pb-1 ">
    <a href="https://www.techasoft.com/" class="techasoft__link--style">Techasoft</a> delivers the complete solution software for the management of all school operations from exams to events. We also offer the common interactive platform to combine parents, students and teachers for the online report of daily class activities. Our solution fits perfectly in your needs and requirements.
    </p>
    <p class="text-justify px-5 pb-1 ">
    ...
    <strong>Students information</strong> – we keep track of every student’s information like attendance, homework, discipline, score etc. which can be accessed easily when needed by the teachers or school managing committee. In addition to these, the basic database is also available like name, contact, address, parent’s information, medical history and many more.
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    <strong>Parents portal</strong> – to help parents evaluate their child’s educational activities, send notice of meetings and annual reports and to bring them in contact with teachers.
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    <strong>Assessments and assignments</strong> - a different set of examination papers can be prepared by teachers easily for avoiding cheating.
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    <strong>Report cards</strong> – the annual report of the academic year can be easily generated by the authorities using our interactive database. Using our school management system software, report cards can be made easily accessible to the parents and students to help them improve their grades.
    </li>
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    <strong>Fee tracking and online payment</strong> – our system can manage receipts and fee payments of students also. It is very convenient to use the software for preparation of fee booklets and receipts.
    </li>
    </ul>
    </div>
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1 ">
    TECHASOFT has a team of well trained, qualified professionals that are highly focused, dedicated and experienced. We deliver secure and friendly solutions for educational institutions. For the hassle-free management of your school or educational institute, TECHASOFT works as the foremost <strong>school management system software development company</strong>. We can feel your burden that’s why our solutions are delivered to reduce your efforts.
    </p>
    </div>
    ...
    <input hidden="" type="text" value="/school-management-software-development-company" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/school-management-software-development-company" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=uhcwxppbo4nl" width="304" height="78" role="presentation" name="a-k06jdah4sjm9" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
