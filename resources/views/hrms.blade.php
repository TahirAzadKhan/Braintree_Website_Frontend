@include('app')
    ...
    <section class="product_description--cta">
    <div class="container">
    <div class="row" style="height: 35vh;">
    <div class="col-sm-5 text-center">
    <h1 class="font-weight-bold vertical-alignment">HUMAN RESOURCE MANAGEMENT SYSTEM <br>PROCESS</h1>
    </div>
    <div class="col-sm-7 main-image text-center">
    <img src="https://www.techasoft.com/debug/img/TS-Logo-LArge-1.png" alt="A Techasoft Product" width="80%" height="80%" class="product-drlog">
    </div>
    </div>
    ...
    <div class="row mt-4">
    <div class="col-md-12 product-demo text-center">
    <a href="#" target="_blank" class="social-btns">
    <img src="https://www.techasoft.com/debug/img/web.png" alt="Website" class="btn-color social-btn-color" style="width:18%"></a>
    </div>
    </div>
    </div>
    </section>
    ...
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">About HRMS</h2>
    </div>
    </div>
    ...
    <li><i class="fa fa-users mr-3"></i>Employee management</li>
    <li><i class="fas fa-clipboard-list mr-3"></i>Attendance</li>
    <li><i class="fas fa-bullseye mr-3"></i>Training</li>
    <li><i class="fas fa-stopwatch mr-3"></i>Task scheduling</li>
    </ul>
    </div>
    </div>
    <div class="col-md-6 ">
    <div class="product_list">
    <ul class="square mb-0">
    <li><i class="far fa-calendar-times mr-3"></i>Leave management</li>
    <li><i class="fas fa-money-bill mr-3"></i>Payroll</li>
    <li><i class="fas fa-project-diagram mr-3"></i>Project </li>
    <li><i class="far fa-file mr-3"></i>Report</li>
    </ul>
    </div>
    </div>
    </div>
    ...
    <a href="#" class="btn-color-parent" target="_blank">
    <input type="button" value="Demo" class="py-3 px-5 btn-color">
    </a>
    ...
    <img class="card-img-top our-prod--images px-5 pt-2 image-shadow-common" src="https://www.techasoft.com/debug/img/doctor_click.png" alt="A Techasoft Product">
    <div class="card-body fixed-card-height">
    <p class="card-text">Doctor click away has been designed to connect with doctors</p>
    </div>
    <div class="card-body text-center">
    <a href="https://www.techasoft.com/doctor-click-away" class="btn-color-parent">
    ...
    <div class="card card-prod-shadow h-100">
    <img class="card-img-top our-prod--images px-5 pt-2 image-shadow-common" src="https://www.techasoft.com/debug/img/school_pnt.png" alt="A Techasoft Product">
    <div class="card-body fixed-card-height">
    <p class="card-text">Get School ERP system and connect parents with school</p>
    </div>
    <div class="card-body text-center">

    <a href="https://www.techasoft.com/school-pnt" class="btn-color-parent">
    <input type="button" value="Learn More" class="btn-color py-3 px-5 ">
    </a>
    </div>
    </div>
    ...
    <input hidden="" type="text" value="/hrms" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/hrms" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=syscle2ob780" width="304" height="78" role="presentation" name="a-ix6f2a1p89pf" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
