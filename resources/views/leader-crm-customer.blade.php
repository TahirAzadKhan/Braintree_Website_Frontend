@include('app')
    ...
    <h1 class="font-weight-bold vertical-alignment">Leader CRM (Customer Relationship Management)Application</h1>
    </div>
    <div class="col-sm-7 main-image text-center">
    <img src="https://www.techasoft.com/uploads/App_Icon_512x512.png" alt="product page image" width="60%" height="60%" class="product-drlog">
    </div>
    </div>
    <div class="hero-text"><br>
    <h2 class="text-center">Works on Web</h2>
    </div>
    <div class="row mt-4">
    <div class="col-sm-4 product-demo text-center">
    <a href="https://crm.techasoft.com/" target="_blank" class="social-btns">
    <img src="https://www.techasoft.com/debug/img/web.png" alt="Website" class="btn-color social-btn-color" style="width:50%"></a>
    </div>
    <div class="col-sm-4 gplay text-right">
    <a href="https://play.google.com/store/apps/details?id=com.techasoft.lead" target="_blank" class="social-btns my-md-auto my-3">
    <img src="https://www.techasoft.com/debug/img/Google play.png" alt="Google play" class="social-btn-color" style="width:50%"></a>
    </div>
    <div class="col-sm-4 social-btns text-center astore">
    <a href="https://apps.apple.com/us/app/leader-crm/id1577402840" target="_blank">
    <img src="https://www.techasoft.com/debug/img/App Store.png" alt="App Store" class="social-btn-color" style="width:50%"></a>
    </div>
    </div>
    </div>
    </section>
    ...
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">About Leader CRM (Customer Relationship Management)Application</h2>
    </div>
    </div>
    ...
    <div class="row technology_contents-ui" hidden="">
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">Our Clients</h2>
    </div>
    <div class="row">
    <div class="col-md-4 card-margin offset-2">
    <div class="card card-prod-shadow h-100">
    <img class="card-img-top our-prod--images px-5 pt-2 image-shadow-common" src="https://www.techasoft.com/debug/img/carelick.png" alt="A Techasoft Product">
    <div class="card-body fixed-card-height">
    <p class="card-text">Carelick into a respectable and reliable social institution geared towards caring for the needy</p>
    </div>
    <div class="card-body text-center">
    <a href="https://www.techasoft.com/carelick" class="btn-color-parent">
    ...
    <div class="card card-prod-shadow h-100">
    <img class="card-img-top our-prod--images px-5 pt-2 image-shadow-common" src="https://www.techasoft.com/debug/img/Bravo-bgLogo.png" alt="A Techasoft Product">
    <div class="card-body fixed-card-height">
    <p class="card-text">Bravo Pharma has its own diagnostic laboratories and medical centres</p>
    </div>
    <div class="card-body text-center">
    <a href="https://www.techasoft.com/bravo-pharma" class="btn-color-parent">
    <input type="button" value="Learn More" class="btn-color py-3 px-5 ">
    </a>
    </div>
    </div>
    ...
    <input hidden="" type="text" value="/leader-crm-customer-relationship-management-application" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/leader-crm-customer-relationship-management-application" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=8i52l5krb70a" width="304" height="78" role="presentation" name="a-2scfbxvzcyvz" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
