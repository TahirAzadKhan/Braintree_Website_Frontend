@include('app')
    <style>
        .backgrund-image-txt-left {
            background-image: url("https://www.techasoft.com/debug/img/restaurant_web.jpg");
        }
    </style>
    <main>
    ...
    <h1 class="text-center m-auto">RESTAURANT WEB PORTAL DEVELOPMENT</h1>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">Restaurant web portal development</h2>
    </div>
    </div>
    <div class="row project-mean">
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1 ">
    <strong>Restaurant web portal development company</strong> acts as the most profitable business in all time. The Techasoft is the leading IT development Company for the <strong>Restaurant web portal development company in Bangalore.</strong> Our organization has an experience over the years with the certified team of best experts. Our hardworking and dedicated team promises our client with the best website. As there are numerous ways to deliver services to the restaurants, we are delightfully challenged to the various requirements that should be met to develop a restaurant web portal that would work best for our clients.
    </p>
    <p class="text-justify px-5 pb-1 ">
    ...
    <input hidden="" type="text" value="/Restaurant-web-portal-development-company" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/Restaurant-web-portal-development-company" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=obe34kl76lic" width="304" height="78" role="presentation" name="a-2dleng9ezjv" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
