@include('app')
    ...
    <h1 class="text-uppercase font-weight-bold services_head">WEBSITE DEVELOPMENT COMPANY</h1>
    </div>
    <div class="col-md-6 img-div">
    <img src="https://www.techasoft.com/debug/img/website_development.png" class="img-fluid" alt="About image" style="width: 80%;">
    </div>
    </div>
    </div>
    </div>
    ...
    <p class="text-justify px-5 pb-1 ">
    <a href="https://www.techasoft.com/" class="techasoft__link--style">Techasoft</a>, being a top-notch <strong>website developing company in Bangalore</strong> is providing all kind of website development services that too at an effective cost. We are having a creative, dedicated and experienced team with us to complete all operations regarding websites. Techasoft is a well progressive <strong>Web Development Company in Bangalore</strong>, which is working across the globe.
    </p>
    </div>
    </div>
    </div>
    ...
    <div class="col-sm-12">
    <h4 class="font-weight-bold text-let pb-2 text-center">Why are we <strong>best web Development Company in Bangalore?</strong></h4>
    <h5 class="pb-3 font-weight-bold optimize px-5 pb-1">Creativity</h5>
    <p class="text-justify para-color px-5 pb-1">
    Techasoft has proven past experience, in terms of creativity and quality. Techasoft provides unique web designs and themes for their clients as per their requirements and budget to make every website standout from the crowd. Our experienced web development works wholeheartedly to meet your business needs.
    </p>
    </div>
    <div class="col-md-12">
    <h5 class="pb-3 font-weight-bold optimize px-5 pb-1">Responsive</h5>
    <p class="text-justify para-color px-5 pb-1">
    ...
    <div class="col-md-12">
    <h5 class="pb-3 font-weight-bold optimize px-5 pb-1">Effective</h5>
    <p class="text-justify para-color px-5 pb-1">
    Techasoft can make your website the most effective one so that you can generate a larger number of sales as a gem. Our web developer team develops a website in order to achieve more sales, rather than that, it also converts your website visitors into customers.
    </p>
    </div>
    <div class="col-md-12">
    <h5 class="pb-3 font-weight-bold optimize px-5 pb-1">Customized</h5>
    <p class="text-justify  para-color px-5 pb-1">
    ...
    <div class="row technology_contents-ui">
    <div class="col-sm-12">
    <h4 class="font-weight-bold text-let pb-2 text-center">Techasoft Star picks</h4>
    <p class="text-justify para-color px-5 pb-1">
    Highly functional interactive websites with the user-friendly interface &amp; smooth navigation.
    </p>
    </div>
    <div class="col-sm-12">
    <p class="text-justify para-color px-5 pb-1">
    Mobile optimized responsive website development.
    </p>
    </div>
    <div class="col-sm-12">
    <p class="text-justify para-color px-5 pb-1">
    Complex HTML 5 Animations, Gaming &amp; custom interactivity according to your devices.
    </p>
    </div>
    <div class="col-sm-12">
    <p class="text-justify para-color px-5 pb-1">
    ...
    <div class="col-sm-12">
    <p class="text-justify para-color px-5 pb-1">
    A well-developed website has unlimited potential to attain the maximum reach of the business. Techasoft is a leading <strong>web development company in Bangalore</strong> that understands each and every micro information about the website and business to provide the excellent services out of best. The crucial part of designing any website is understanding the main motive of the website and its user interface that acts like a magnet to the customers. Customer satisfaction is the backbone of our organization and we continuously work hard to maximize it and gives the rich experience with one of the best website development company in Bangalore - Techasoft.
    </p>
    </div>
    ...
    <input hidden="" type="text" value="/Website-Development-Company-in-Bangalore" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/Website-Development-Company-in-Bangalore" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=dol8ey7o2dwa" width="304" height="78" role="presentation" name="a-mhewd9ko39mf" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
