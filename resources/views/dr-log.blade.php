@include('app')
    ...
    <h1 class="font-weight-bold vertical-alignment">Dr. Log</h1>
    </div>
    <div class="col-sm-7 main-image text-center">
    <img src="https://www.techasoft.com/uploads/drlog_new.png" alt="product page image" width="60%" height="60%" class="product-drlog">
    </div>
    </div>
    ...
    <a href="https://www.drlog.in/" target="_blank" class="social-btns">
    ...
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">About Dr. Log</h2>
    </div>
    </div>
    ...
    <input hidden="" type="text" value="/dr-log" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/dr-log" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=90fr30k9r514" width="304" height="78" role="presentation" name="a-58xgyn6fmdfz" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
