@include('app')
    ...
    <h1 class="text-uppercase font-weight-bold services_head">JEWELLERY SOFTWARE</h1>
    </div>
    <div class="col-md-6 img-div">
    <img src="https://www.techasoft.com/debug/img/jewel-software.png" class="img-fluid" alt="About image">
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">Using Technology For Decades To Glow Your Business</h2>
    </div>
    </div>
    <div class="row project-mean">
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1 ">
    <a href="https://www.techasoft.com/" class="techasoft__link--style">Techasoft</a> is a well-known brand name and is ranked as the top jewellery software development company in the whole country with a team of high profile engineers and many years of experience. Our solutions are unique and highly in demand owing to its various features like rapid operations, easy to use, error-free management etc. We expertise in delivering reliable and efficient software to manage sales, purchase and payments data accurately.
    </p>
    <p class="text-justify px-5 pb-1 ">
    ...
    <input hidden="" type="text" value="/jewellery-software-development-company" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <input hidden="" type="text" value="/jewellery-software-development-company" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=za0rfyjdt7g3" width="304" height="78" role="presentation" name="a-a3vn0itk4lqz" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
