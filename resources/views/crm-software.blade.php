@include('app')
    ...
    <div class="col-12">
    <div class="row">
    <div class="col-md-6 headings-text">
    <h1 class="text-uppercase font-weight-bold services_head">CRM Software Development</h1>
    <div class="d-flex align-items-center">
    <a href="https://crm.techasoft.com/" class="btn btn-warning get_started_banner mr-2">
    Request Free Trial
    </a>
    <a href="https://play.google.com/store/apps/details?id=com.techasoft.lead" class="btn btn-warning get_started_banner mt-lg-0 mt-md-3 mr-2">
    Google Play
    </a>
    <a class="red-video-play text-center" data-toggle="modal" data-target="#watch-video-tour">
    <i class="fas fa-play-circle  ytbe_play-btn pt-2 " style="margin-top: -4px;"></i>
    </a>
    </div>
    </div>
    <div class="col-md-6 img-div">
    <img src="https://www.techasoft.com/debug/img/crm.png" class="img-fluid" alt="About image">
    </div>
    </div>
    </div>
    </div>
    ...
    <a href="https://www.techasoft.com/" class="techasoft__link--style">Techasoft</a> the topmost CRM Software development company in Bangalore is
    ...
    <div class="col-sm-12">
    <h2 class="font-weight-bold text-let pb-2 text-center">Why Techasoft for CRM Software development?</h2>
    </div>
    </div>
    <div class="row project-mean">
    <div class="col-sm-12">
    <p class="text-justify px-5 pb-1 ">
    Techasoft is considered as one of the best CRM Software Development Company in Bangalore has all the capabilities to fulfil your need for business management. There is no doubt that CRM can be a star tool and an effective strategy to enhance consumer’s relations and market value.</p>
    <p class="text-justify px-5 pb-1">
    The goal of the CRM is to improve the relationship with customers and establish a loyal customer base for the organization. Improved relationships are directly related more productivity and growth of the organization. CRM tool is used to contact management, sales management, productivity and more. Techasoft implies smart strategies and tactics according to business types and needs after analyzing your interactions with customers and accordingly implement strategies to improve business relationship with them. Our main focus is on customer retention and sales growth.</p>
    </div>
    </div>
    </div>
    <div class="product-description--div p-4">
    <div class="row technology_contents-ui">
    <div class="col-sm-12 px-5 pb-1">
    <h2 class="font-weight-bold text-let pb-2 text-center">Why Techasoft is the best software development company in Bangalore?</h2>
    <p class="text-justify para-color">
    <strong>Techasoft can be the best choice for this project because :</strong></p>
    </div>
    <div class="col-sm-12 para-color px-5 pb-1">
    ...
    <li class="ml-1">
    <img src="https://www.techasoft.com/debug/img/tick.svg" class="img-fluid list-icon-large" alt="tick" width="20" height="20">
    Techasoft initiates on-time services with 100% transparency.
    </li>
    </ul>
    </div>
    </div>
    ...
    <div class="product-description--div p-4">
     <div class="row technology_contents-ui">
    <div class="col-sm-12 px-5 pb-1">
    <h4 class="font-weight-bold text-let pb-2 text-center">Who Can Use CRM?</h4>
    <h5 class="pb-3 font-weight-bold optimize">Start-ups</h5>
    <p class="text-justify para-color">
    ...
    <div class="col-sm-12 px-5 pb-1">
    <h5 class="pb-3 font-weight-bold optimize">Small businesses</h5>
    <p class="text-justify para-color">
    ...
    <div class="col-sm-12 px-5 pb-1">
    <h5 class="pb-3 font-weight-bold optimize">Enterprises</h5>
    <p class="text-justify para-color">
    ...
    <p class="text-justify para-color">CRM lets you automate ordinary tasks like building leads from signup forms and
    sending welcome emails to new leads. Spreadsheets demand data entry; CRM minimizes it.</p>
    </div>
    <div class="col-sm-12 px-5 pb-1">
    <h5 class="pb-3 font-weight-bold optimize">Enhanced relationships with clients</h5>
    <p class="text-justify para-color">
    ...
    <div class="col-sm-12 px-5 pb-1">
    <h5 class="pb-3 font-weight-bold optimize">High-grade communication</h5>
    <p class="text-justify para-color">
    The CRM system becomes a single source of fact for every member of your team. No data gaps,
    no back-and-forth—the customer hears a steady voice from your business.</p>
    </div>
    <div class="col-sm-12 px-5 pb-1">
    <h5 class="pb-3 font-weight-bold optimize">Greater revenue</h5>
    <p class="text-justify para-color">
    ...
    <div class="col-sm-12 px-5 pb-1">
    <h5 class="pb-3 font-weight-bold optimize">Better pipelines</h5>
    <p class="text-justify para-color">
    ...
    <p class="text-justify para-color">More collaboration = a strong business</p>
    <p class="text-justify para-color">Data in the CRM is useful not just for your sales team, but for marketing and support too.
    ...
    <input hidden="" type="text" value="/crm-software-development" class="form-control" id="" name="lead_url" required="">
    <div class="col-12">
    ...
    <div class="modal fade" id="watch-video-tour" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <iframe class="embed-responsive-item paste_video_url" width="100%" height="315" src="https://www.youtube.com/embed/McrJygNdcUA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
    </div>
    </div>
    </div>
    </div>
    ...
    <script>
        ...
        $('#watch-video-tour').on('hidden.bs.modal', function () {
            $("#watch-video-tour iframe").attr("src", $("#watch-video-tour iframe").attr("src"));
        });
        <!--stop video when modal closes-->
        $('#watch-video-tour').on('hide.bs.modal', function(e) {
    ...
    <input hidden="" type="text" value="/crm-software-development" class="form-control" id="usr" name="lead_url" required="">
    ...
    <div class="g-recaptcha" data-sitekey="6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfJdP4ZAAAAAHLu7rilqtpQdkdiZo90482PBgLN&amp;co=aHR0cHM6Ly93d3cudGVjaGFzb2Z0LmNvbTo0NDM.&amp;hl=en&amp;v=dPctOHA2ifhWm5WzFM_B5TjT&amp;size=normal&amp;cb=9givnxk53gpd" width="304" height="78" role="presentation" name="a-fer4kvejra6r" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
